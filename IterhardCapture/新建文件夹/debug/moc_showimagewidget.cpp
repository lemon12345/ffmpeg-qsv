...
QT_MOC_LITERAL(1, 16, 9), // "loadImage"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 5) // "image"

    },
    "showImageWidget\0loadImage\0\0image"
};
...
const QMetaObject showImageWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_showImageWidget.data,
      qt_meta_data_showImageWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *showImageWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_showImageWidget.stringdata0))
        return static_cast<void*>(const_cast< showImageWidget*>(this));
